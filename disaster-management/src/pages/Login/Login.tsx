        ...
        <div className="min-h-screen bg-background flex items-center justify-center p-4">
            <div className="bg-card border border-border rounded-lg shadow-xl p-8 w-full max-w-md">
                ...
                <button
                    ...
                    disabled={loading}
                    className="w-full bg-white text-gray-700 border border-gray-300 py-3 rounded-md font-semibold hover:bg-gray-50 transition-colors disabled:opacity-50 shadow-sm flex items-center justify-center gap-3 mb-6"
                >
